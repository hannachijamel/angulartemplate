        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    {label: 'Degre', icon: 'pi pi-fw pi-circle', routerLink: ['/uikit/degre']},
                    {label: 'Site', icon: 'pi pi-fw pi-circle', routerLink: ['/uikit/site']},
                    {label: 'Emplacement', icon: 'pi pi-fw pi-circle', routerLink: ['/uikit/emplacement']},
                    {label: 'Type Emplacement', icon: 'pi pi-fw pi-circle', routerLink: ['/uikit/typeemplacement']},
                    {label: 'Conditionnel', icon: 'pi pi-fw pi-circle', routerLink: ['/uikit/conditionnel']}
                ]
            },
            {
                label:'Prime Blocks',
